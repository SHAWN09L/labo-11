...
function makeMove(column) {
	...
	// Le jeu quitte aprÃ¨s une victoire
	process.exit();
	}
...
function askMove() {
	f();
	// old version
	// rl.question(`Yo ${currentPlayer}, c'est Ã  toi de choisir une colonne (0-6): `, (answer) => {
	rl.question(`Joueur ${currentPlayer}, choisissez une colonne (0-6): `, (answer) => {
		...
		// Boucle infinie pour continuer Ã  demander des mouvements
		askMove();
	});
}

console.log("Bienvenue Ã  Connect 4!");
askMove();